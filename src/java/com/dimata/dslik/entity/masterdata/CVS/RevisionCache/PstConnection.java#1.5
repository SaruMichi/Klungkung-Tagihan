...
//public static final  String TBL_P2_LOCATION = "LOCATION";
    ...
    public static final int FLD_JENIS_LJK=15;
    public static final int FLD_KODE_LJK=16;
    public static final int FLD_PATH_DELIMITED_TEXT=17;
    public static final int FLD_PATH_DELIMITED_TEXT_SUMMARY=18;
    public static final int FLD_DATABASE=19;
    public static final int FLD_DATABASE_BACKUP=20;
    public static final int FLD_TYPE_CREATE_FILE =21; //update opie-eyek 20130805
    ...
    public long fetchExc(Entity ent) throws Exception {
        try {
            ...
            conn.setJenisLJK(pstconn.getString(FLD_JENIS_LJK));
            conn.setKodeLJK(pstconn.getString(FLD_KODE_LJK));
            conn.setPathDelimitedText(pstconn.getString(FLD_PATH_DELIMITED_TEXT));
            conn.setPathDelimitedTextSummary(pstconn.getString(FLD_PATH_DELIMITED_TEXT_SUMMARY));
            conn.setDbDatabase(pstconn.getString(FLD_DATABASE));
            conn.setDbDatabaseBackup(pstconn.getString(FLD_DATABASE_BACKUP));
            conn.setTypeCreateFile(pstconn.getInt(FLD_TYPE_CREATE_FILE));
    ...
    public static long insertExc(OutletConnection conn) throws DBException {
        try {
            ...
            pstconn.setString(FLD_JENIS_LJK, conn.getJenisLJK());
            pstconn.setString(FLD_KODE_LJK, conn.getKodeLJK());
            pstconn.setString(FLD_PATH_DELIMITED_TEXT, conn.getPathDelimitedText());
            pstconn.setString(FLD_PATH_DELIMITED_TEXT_SUMMARY, conn.getPathDelimitedTextSummary());
            pstconn.setString(FLD_DATABASE, conn.getDbDatabase());
            pstconn.setString(FLD_DATABASE_BACKUP, conn.getDbDatabaseBackup());
            pstconn.setInt(FLD_TYPE_CREATE_FILE, conn.getTypeCreateFile());
    ...
    private static void resultToObject(ResultSet rs, OutletConnection conn) {
        try {
            ...
            conn.setJenisLJK(rs.getString(PstConnection.fieldNames[PstConnection.FLD_JENIS_LJK]));
            conn.setKodeLJK(rs.getString(PstConnection.fieldNames[PstConnection.FLD_KODE_LJK]));
            conn.setPathDelimitedText(rs.getString(PstConnection.fieldNames[PstConnection.FLD_PATH_DELIMITED_TEXT]));
            conn.setPathDelimitedTextSummary(rs.getString(PstConnection.fieldNames[PstConnection.FLD_PATH_DELIMITED_TEXT_SUMMARY]));
            conn.setDbDatabase(rs.getString(PstConnection.fieldNames[PstConnection.FLD_DATABASE]));
            conn.setDbDatabaseBackup(rs.getString(PstConnection.fieldNames[PstConnection.FLD_DATABASE_BACKUP]));
            conn.setTypeCreateFile(rs.getInt(PstConnection.fieldNames[PstConnection.FLD_TYPE_CREATE_FILE]));
