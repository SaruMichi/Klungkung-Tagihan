 ...
 * @author Dewa
 */
public class ContentDataStatusAgunan extends Entity {

    private String namaStatusAgunan = "";
    private String kodeCoreBanking = "";
    private String kodeOjk = "";

    public String getNamaStatusAgunan() {
        return namaStatusAgunan;
    }

    public void setNamaStatusAgunan(String namaStatusAgunan) {
        this.namaStatusAgunan = namaStatusAgunan;
    }
