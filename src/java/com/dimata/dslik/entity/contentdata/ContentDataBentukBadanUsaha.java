...
public class ContentDataBentukBadanUsaha extends Entity {

    private String bentukBadanUsaha = "";
    private String kodeCoreBanking = "";
    private String kodeOjk = "";

    public String getBentukBadanUsaha() {
        return bentukBadanUsaha;
    }

    public void setBentukBadanUsaha(String bentukBadanUsaha) {
        this.bentukBadanUsaha = bentukBadanUsaha;
    }
