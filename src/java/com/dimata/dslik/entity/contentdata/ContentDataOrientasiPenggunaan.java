 ...
 * @author Dewa
 */
public class ContentDataOrientasiPenggunaan extends Entity {

    private String namaOrientasiPenggunaan = "";
    private String kodeCoreBanking = "";
    private String kodeOjk = "";

    public String getNamaOrientasiPenggunaan() {
        return namaOrientasiPenggunaan;
    }

    public void setNamaOrientasiPenggunaan(String namaOrientasiPenggunaan) {
        this.namaOrientasiPenggunaan = namaOrientasiPenggunaan;
    }
