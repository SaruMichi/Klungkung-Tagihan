 ...
 * @author Dewa
 */
public class ContentDataSektorEkonomi extends Entity {

    private String namaSektorEkonomi = "";
    private String kodeCoreBanking = "";
    private String kodeOjk = "";

    public String getNamaSektorEkonomi() {
        return namaSektorEkonomi;
    }

    public void setNamaSektorEkonomi(String namaSektorEkonomi) {
        this.namaSektorEkonomi = namaSektorEkonomi;
    }
