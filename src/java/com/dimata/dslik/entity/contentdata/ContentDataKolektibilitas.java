 ...
 * @author Dewa
 */
public class ContentDataKolektibilitas extends Entity {

    private String namaKolektibilitas = "";
    private String kodeCoreBanking = "";
    private String kodeOjk = "";

    public String getNamaKolektibilitas() {
        return namaKolektibilitas;
    }

    public void setNamaKolektibilitas(String namaKolektibilitas) {
        this.namaKolektibilitas = namaKolektibilitas;
    }
