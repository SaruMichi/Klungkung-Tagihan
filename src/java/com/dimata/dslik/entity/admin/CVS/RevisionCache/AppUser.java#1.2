...
public class AppUser extends Entity {
    ...
    /**
     * @return the kdCabangBank
     */
    public String getKdCabangBank() {
        return kdCabangBank;
    }

    /**
     * @param kdCabangBank the kdCabangBank to set
     */
    public void setKdCabangBank(String kdCabangBank) {
        this.kdCabangBank = kdCabangBank;
    }
