 ...
 * @author dimata005
 */
public class ManagerTransferDataBankGaransi {
    ...
    public static void startTransfer(){    
        ...
        if(running) return;
            ...
            ManagerTransferDataBankGaransi objMan = new  ManagerTransferDataBankGaransi();

            Thread thLocker = new Thread(new MonitorTransferDataBankGaransi());
    ...
    public static String getStatusBankGaransiStatic() {
        return statusBankGaransi;
    }
