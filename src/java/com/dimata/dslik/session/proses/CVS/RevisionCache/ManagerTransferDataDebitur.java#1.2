 ...
 * @author dimata005
 */
public class ManagerTransferDataDebitur {
    ...
    public static MonitorTransferDataDebitur lck = new MonitorTransferDataDebitur();
    ...
    public static void startTransfer(){    
        ...
        if(running) return;
            ...
            ManagerTransferDataDebitur objMan = new  ManagerTransferDataDebitur();

            Thread thLocker = new Thread(new MonitorTransferDataDebitur());
