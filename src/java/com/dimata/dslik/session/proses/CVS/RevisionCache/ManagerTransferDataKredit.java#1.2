 ...
 * @author dimata005
 */
public class ManagerTransferDataKredit {
    ...
    public static ManagerTransferDataKredit lck = new ManagerTransferDataKredit();
    ...
    public static void startTransfer(){    
        ...
        if(running) return;
            ...
            ManagerTransferDataKredit objMan = new  ManagerTransferDataKredit();

            Thread thLocker = new Thread(new MonitorTransferDataKredit());
