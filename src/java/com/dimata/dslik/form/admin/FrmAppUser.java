...
package com.dimata.dslik.form.admin;

import com.dimata.dslik.entity.admin.AppUser;
import com.dimata.dslik.entity.admin.UserGroup;
...
public class FrmAppUser extends FRMHandler implements I_FRMInterface, I_FRMType {
    ...
    public static  final String[] fieldNames = {
        ...
        , "USER_GROUP","EMPLOYEE_ID","USER_GROUP_NEW","FRM_FIELD_START_TIME","FRM_FIELD_END_TIME"
    } ;
    ...
    public static Vector getOtomatisUserGroup(long userOID, String groupId){
        Vector userGroups = new Vector(1,1);
        long groupOID = Long.parseLong(groupId);
        UserGroup ug = new UserGroup();
        ug.setUserID(userOID);
        ug.setGroupID(groupOID);
        userGroups.add(ug);
