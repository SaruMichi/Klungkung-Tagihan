...
import com.dimata.dslik.form.contentdata.CtrlContentDataKondisi;
...
public class AjaxCdKondisi extends HttpServlet {
    ...
    public JSONObject getData(int total, HttpServletRequest request, String datafor) {
        ...
        for (int i = 0; i <= listData.size() - 1; i++) {
            ...
            if (datafor.equals("list")) {
                ...
                if(privUpdate){
                    buttonAction += "<button type='button' class='btn btn-warning btneditgeneral' data-oid='" + contentDataKondisi.getOID() + "' data-for='showform'><i class='fa fa-pencil'></i> Edit</button>";
                }
                if(privDelete){
    ...
    public String showForm(HttpServletRequest request) {
        ...
        String returnData = ""
                ...
                + "<input type='text' class='form-control' name='" + FrmContentDataKondisi.fieldNames[FrmContentDataKondisi.FRM_FIELD_NAMA_KONDISI] + "' value='" + contentDataKondisi.getNamaKondisi()+ "'>"
                + "</div>"
                + "<div class='form-group'>"
                + "<label>Kode Core Banking</label>"
                + "<input type='text' class='form-control' name='" + FrmContentDataKondisi.fieldNames[FrmContentDataKondisi.FRM_FIELD_KODE_CORE_BANKING] + "' value='" + contentDataKondisi.getKodeCoreBanking() + "'>"
                + "</div>"
                + "<div class='form-group'>"
                + "<label>Kode OJK</label>"
                + "<input type='text' class='form-control' name='" + FrmContentDataKondisi.fieldNames[FrmContentDataKondisi.FRM_FIELD_KODE_OJK] + "' value='" + contentDataKondisi.getKodeOjk() + "'>"
                + "</div>"
                + "</div>"
                + "</div>";
