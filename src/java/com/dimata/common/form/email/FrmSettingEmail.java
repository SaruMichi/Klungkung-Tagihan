...
public class FrmSettingEmail extends FRMHandler implements I_FRMInterface, I_FRMType{
    ...
    public static final int FRM_CC_EMAIL                = 4;
    public static final int FRM_DOMAIN_ROOT             = 5;

     public static  final String[] fieldNames = {
        "EMAIL_NAME", "PASSWORD", "HOST","PORT","CC_EMAIL","DOMAIN_ROOT"
    } ;
     ...
     public void requestEntityObject(SettingEmail entObj)
    {
        try {
            ...
            entObj.setCcEmail(this.getString(FRM_CC_EMAIL));
            entObj.setDomainRoot(this.getString(FRM_DOMAIN_ROOT));
