...
public class LogSysHistory extends Entity{
    ...
    /**
     * @return the queryRoleBack
     */
    public String getQueryRoleBack() {
        return queryRoleBack;
    }

    /**
     * @param queryRoleBack the queryRoleBack to set
     */
    public void setQueryRoleBack(String queryRoleBack) {
        this.queryRoleBack = queryRoleBack;
    }
