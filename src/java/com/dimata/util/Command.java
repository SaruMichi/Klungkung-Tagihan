...
public class Command {
    ...
    public static String commandString[] = {
        ...
        "Ask", "Posting", "Reposting", "Add All", "Save All", "Delete All", "Download Data"
    };
    
    
    public static final int SSP_FORM = 78;
    public static final int RES_OK = 79;
    public static final int RES_ERROR = 80;
