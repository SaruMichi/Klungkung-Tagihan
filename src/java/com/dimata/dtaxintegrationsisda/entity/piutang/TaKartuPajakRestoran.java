 ...
 * @author AYUKI
 */
public class TaKartuPajakRestoran extends Entity {
    private int tahun = 0;
    ...
    private double jmlMeja = 0;
    private double jmlKursi = 0;
    private double jmlPengunjung = 0;
    private int kas = 0;
     ...
     * @return the jmlMeja
     */
    public double getJmlMeja() {
        return jmlMeja;
    }

    /**
     * @param jmlMeja the jmlMeja to set
     */
    public void setJmlMeja(double jmlMeja) {
     ...
     */
    public void setJmlKursi(double jmlKursi) {
        this.jmlKursi = jmlKursi;
    }

    /**
     * @return the jmlPengunjung
     */
    public double getJmlPengunjung() {
        return jmlPengunjung;
    }

    /**
     * @param jmlPengunjung the jmlPengunjung to set
     */
    public void setJmlPengunjung(double jmlPengunjung) {
