...
<%
    ...
    if(session.getValue(SessUserWPSession.HTTP_SESSION_WPNAME)==null){
        ...
        listCompareESPTPD = PstCompareEsptpd.listJoinAll(0, 0, "viewUser."+PstAppUserWP.fieldNames[PstAppUserWP.FLD_NPWPD]+"='"+idUser+"' and sptpd."+PstESPTPD.fieldNames[PstESPTPD.FLD_MASA_PAJAK]+"='"+paramSplit[1]+"' and sptpd."+PstESPTPD.fieldNames[PstESPTPD.FLD_TAHUN_PAJAK]+"='"+paramSplit[2]+"'", "");
    }else{
        listNamaBadan = PstNamaBadan.listJoinSpt(0, 0, 
	    "viewUser."+PstAppUserWP.fieldNames[PstAppUserWP.FLD_USER_ID]+"='"+ session.getValue(SessUserWPSession.HTTP_SESSION_WPNAME) +"'", "");
        listCompareESPTPD = PstCompareEsptpd.listJoinAll(0, 0, "viewUser."+PstAppUserWP.fieldNames[PstAppUserWP.FLD_USER_ID]+"='"+session.getValue(SessUserWPSession.HTTP_SESSION_WPNAME)+"' and sptpd."+PstESPTPD.fieldNames[PstESPTPD.FLD_MASA_PAJAK]+"='"+paramSplit[1]+"' and sptpd."+PstESPTPD.fieldNames[PstESPTPD.FLD_TAHUN_PAJAK]+"='"+paramSplit[2]+"'", "");
    }
    ...
    if (jmlAlamat>52){
       // alamatWajibPajak;// = alamatWajibPajak.substring(0,50);
