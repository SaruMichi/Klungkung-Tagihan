<%-- 
    Document   : nominatifagunan_new
    Created on : Jan 11, 2017, 6:39:01 AM
    Author     : dimata005
--%>
                        ...
                        <div class="row">
                            <div class="col-xs-12">
                                <div class="box">
                                    <div class="box-body">
                                        <div class="row">
                                            <div class="col-xs-4"><label>Cabang</label>
                                                <%=ControlCombo.draw("cabangpersegment", "Semua Cabang", "" + cabang, cabangKey, cabangVal, "", "form-control")%>
                                            </div>
                                            ...
                                            <div class="col-xs-4"><label>Segment</label>  
                                                            ...
                                                            <table class='table table-bordered'>
                                                                ...
                                                                <tbody>
                                                                    <%
                                                                        int noUrut = 0;
                                                                        double totallTaksasi = 0;
                                                                        String whereClauseKredit = "kredit." + PstKredit.fieldNames[PstKredit.FLD_KODE_KANTOR_CABANG] + "='" + cabang + "' "
                                                                        ...
                                                                        if (listKredit.size() > 0) {
                                                                            ...
                                                                            for (int iK = 0; iK < listKredit.size(); iK++) {
                                                                                ...
                                                                                Vector listAgunan = PstAgunan.list(0, 0, PstAgunan.fieldNames[PstAgunan.FLD_NO_REKENING] + "='" + kredit.getNoRekening() + "' "
                                                                                        + "AND " + PstAgunan.fieldNames[PstAgunan.FLD_KODE_KANTOR_CABANG] + "='" + cabang + "' "
                                                                    ...
                                                                    <%
                                                                        totallTaksasi = totallTaksasi + kredit.getBakiDebet();
                                                                        if (listAgunan.size() > 0) {
