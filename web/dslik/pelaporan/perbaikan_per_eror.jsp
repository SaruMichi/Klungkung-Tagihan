    ...
    <head>
        ...
        <script language="JavaScript">
            ...
            function cmdSearch(){
                ...
                document.driver.action="perbaikan_per_eror.jsp";
                document.driver.submit();
            ...
            function cmdSearchExcel(){
                document.driver.command.value="<%=Command.SEARCH%>";
                document.driver.prev_command.value="<%=prevCommand%>";
                document.driver.action="perbaikan_per_eror_excel.jsp?cabangpersegment=<%=cabang%>&periodepersegment=<%=periodeId%>&segment=<%=getSegment%>&kelengkapan=<%=kelengkapan%>";
                document.driver.submit();
            }
        ...
        <div class="wrapper">
            ...
            <div class="content-wrapper">
                ...
                <section class="content-header">
                    <h1>
                        Laporan 
                        <small>Data Per Detail Error</small>
                    </h1>
                </section>
                <!-- Main content -->
                <%
