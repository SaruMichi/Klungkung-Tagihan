<%-- 
    Document   : cara_restrukturisasi
    Created on : Sep 26, 2016, 7:30:56 AM
    Author     : m20n9
--%>

<%@page import="com.dimata.dslik.form.contentdata.FrmContentDataCaraRestrukturisasi"%>
...
<%
    boolean privView = userSession.checkPrivG1G2ObjCommand(AppObjInfo.G1_MODUL_MASTER_DATA, AppObjInfo.G2_MAPPING_CONTENT_DATA, AppObjInfo.OBJ_CARA_RESTRUKTURISASI, AppObjInfo.COMMAND_VIEW);
    boolean privAdd = userSession.checkPrivG1G2ObjCommand(AppObjInfo.G1_MODUL_MASTER_DATA, AppObjInfo.G2_MAPPING_CONTENT_DATA, AppObjInfo.OBJ_CARA_RESTRUKTURISASI, AppObjInfo.COMMAND_ADD);
    boolean privUpdate = userSession.checkPrivG1G2ObjCommand(AppObjInfo.G1_MODUL_MASTER_DATA, AppObjInfo.G2_MAPPING_CONTENT_DATA, AppObjInfo.OBJ_CARA_RESTRUKTURISASI, AppObjInfo.COMMAND_UPDATE);
    boolean privDelete = userSession.checkPrivG1G2ObjCommand(AppObjInfo.G1_MODUL_MASTER_DATA, AppObjInfo.G2_MAPPING_CONTENT_DATA, AppObjInfo.OBJ_CARA_RESTRUKTURISASI, AppObjInfo.COMMAND_DELETE);
    boolean privDownload = userSession.checkPrivG1G2ObjCommand(AppObjInfo.G1_MODUL_MASTER_DATA, AppObjInfo.G2_MAPPING_CONTENT_DATA, AppObjInfo.OBJ_CARA_RESTRUKTURISASI, AppObjInfo.COMMAND_DOWNLOAD);
    
%>
<html>
    <head>
        <meta charset="UTF-8">
        <title>SLIK | Mapping Cara Restrukturisasi</title>
        ...
        <div class="wrapper">
            ...
            <div class="content-wrapper">
                ...
                <section class="content-header">
                    <h1>
                        Mapping
                        <small>Cara Restrukturisasi</small>
                    </h1>
                </section>
                <!-- Main content -->
                <%
                                        ...
                                        if(privAdd){
                                            %>
                                                <button class="btn btn-primary btnaddgeneral" data-oid="0" data-for="showform">
                                                    <i class="fa fa-plus"></i> Add Cara Restruktutrisasi
                                                </button>
                                            <%
                                        }
                                    %>
                ...
                $(document).ready(function(){
                    ...
                    addeditgeneral = function(elementId){
                        $(elementId).click(function(){
                            ...
                            if(oid != 0){
                                if(dataFor == 'showform'){
                                    $(".addeditgeneral-title").html("Edit Cara Restrukturisasi");
                                }

                            }else{
                                if(dataFor == 'showform'){
                                    $(".addeditgeneral-title").html("Add Cara Restrukturisasi");
                                }
                            }
                            ...
                            getDataFunction(onDone, onSuccess, approot, command, dataSend, "AjaxCdCaraRestrukturisasi", ".addeditgeneral-body", false, "json");
                        });
                    };
                    ...
                    deletegeneral = function(elementId, checkboxelement){
                        ...
                        $(elementId).on("click", checkboxelement, function(){
                            ...
                            if(confirm(confirmText)){
                                ...
                                getDataFunction(onDone, onSuccess, approot, command, dataSend, "AjaxCdCaraRestrukturisasi", null, true, "json");
                    ...
                    //FORM HANDLER
                    chanelForm = function(){
                        validateOptions("#<%=FrmContentDataCaraRestrukturisasi.fieldNames[FrmContentDataCaraRestrukturisasi.FRM_FIELD_RESTRUKTURISASI_OID]%>", 'text', 'has-error', 1, null);
                    }
                    ...
                    function runDataTables(){
                        dataTablesOptions("#countryElement", "tableCountryElement", "AjaxCdCaraRestrukturisasi", "list", callBackDataTables);
                    }
