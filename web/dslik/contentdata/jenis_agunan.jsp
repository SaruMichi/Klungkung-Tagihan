<%-- 
    Document   : jenis_agunan
    Created on : Sep 26, 2016, 7:30:56 AM
    Author     : m20n9
--%>

<%@page import="com.dimata.dslik.form.contentdata.FrmContentDataJenisAgunan"%>
...
<%
    boolean privView = userSession.checkPrivG1G2ObjCommand(AppObjInfo.G1_MODUL_MASTER_DATA, AppObjInfo.G2_MAPPING_CONTENT_DATA, AppObjInfo.OBJ_JENIS_AGUNAN, AppObjInfo.COMMAND_VIEW);
    boolean privAdd = userSession.checkPrivG1G2ObjCommand(AppObjInfo.G1_MODUL_MASTER_DATA, AppObjInfo.G2_MAPPING_CONTENT_DATA, AppObjInfo.OBJ_JENIS_AGUNAN, AppObjInfo.COMMAND_ADD);
    boolean privUpdate = userSession.checkPrivG1G2ObjCommand(AppObjInfo.G1_MODUL_MASTER_DATA, AppObjInfo.G2_MAPPING_CONTENT_DATA, AppObjInfo.OBJ_JENIS_AGUNAN, AppObjInfo.COMMAND_UPDATE);
    boolean privDelete = userSession.checkPrivG1G2ObjCommand(AppObjInfo.G1_MODUL_MASTER_DATA, AppObjInfo.G2_MAPPING_CONTENT_DATA, AppObjInfo.OBJ_JENIS_AGUNAN, AppObjInfo.COMMAND_DELETE);
    boolean privDownload = userSession.checkPrivG1G2ObjCommand(AppObjInfo.G1_MODUL_MASTER_DATA, AppObjInfo.G2_MAPPING_CONTENT_DATA, AppObjInfo.OBJ_JENIS_AGUNAN, AppObjInfo.COMMAND_DOWNLOAD);
    
%>
<html>
    <head>
        <meta charset="UTF-8">
        <title>SLIK | Mapping Jenis Agunan</title>
                                        ...
                                        if(privAdd){
                                            %>
                                                <button class="btn btn-primary btnaddgeneral" data-oid="0" data-for="showform">
                                                    <i class="fa fa-plus"></i> Add Jenis Agunan
                                                </button>
                                            <%
                                        }
                                    %>			
                ...
                $(document).ready(function(){
                    ...
                    addeditgeneral = function(elementId){
                        $(elementId).click(function(){
                            ...
                            if(oid != 0){
                                if(dataFor == 'showform'){
                                    $(".addeditgeneral-title").html("Edit Jenis Agunan");
                                }

                            }else{
                                if(dataFor == 'showform'){
                                    $(".addeditgeneral-title").html("Add Jenis Agunan");
                                }
                            }
                            ...
                            getDataFunction(onDone, onSuccess, approot, command, dataSend, "AjaxCdJenisAgunan", ".addeditgeneral-body", false, "json");
                        });
                    };
                    ...
                    deletegeneral = function(elementId, checkboxelement){
                        ...
                        $(elementId).on("click", checkboxelement, function(){
                            ...
                            if(confirm(confirmText)){
                                ...
                                getDataFunction(onDone, onSuccess, approot, command, dataSend, "AjaxCdJenisAgunan", null, true, "json");
                    ...
                    //FORM HANDLER
                    chanelForm = function(){
                        validateOptions("#<%=FrmContentDataJenisAgunan.fieldNames[FrmContentDataJenisAgunan.FRM_FIELD_JENIS_AGUNAN_OID]%>", 'text', 'has-error', 1, null);
                    }
                    ...
                    function runDataTables(){
                        dataTablesOptions("#countryElement", "tableCountryElement", "AjaxCdJenisAgunan", "list", callBackDataTables);
                    }
