<%-- 
    Document   : kantorCabang
    Created on : Sep 27, 2016, 9:15:36 AM
    Author     : Dewa
--%>

<%@page import="com.dimata.dslik.form.contentdata.FrmContentDataKantorCabang"%>
                            ...
                            <div class='box box-primary'>
                                ...
                                <div class='box-footer'>
                                    <button class="btn btn-primary btnaddgeneral" data-oid="0" data-for="showform">
                                        <i class="fa fa-plus"></i> Add Kantor Cabang
                                    </button>
                ...
                $(document).ready(function () {
                    ...
                    addeditgeneral = function (elementId) {
                        $(elementId).click(function () {
                            ...
                            if (oid != 0) {
                                if (dataFor == 'showform') {
                                    $(".addeditgeneral-title").html("Edit Kantor Cabang");
                                }

                            } else {
                                if (dataFor == 'showform') {
                                    $(".addeditgeneral-title").html("Add Kantor Cabang");
                                }
                            }
                            ...
                            getDataFunction(onDone, onSuccess, approot, command, dataSend, "AjaxCdKantorCabang", ".addeditgeneral-body", false, "json");
                        });
                    };
                    ...
                    deletegeneral = function (tableId, elementId) {
                        ...
                        $(tableId).on("click", elementId, function () {
                            ...
                            if (confirm(confirmText)) {
                                ...
                                getDataFunction(onDone, onSuccess, approot, command, dataSend, "AjaxCdKantorCabang", null, true, "json");
                    ...
                    //FORM HANDLER
              chanelForm = function ()       {
                        validateOptions("#<%=FrmContentDataKantorCabang.fieldNames[FrmContentDataKantorCabang.FRM_FIELD_KANTOR_CABANG_OID]%>", 'text', 'has-error', 1, null);
                    }
                    ...
                    function runDataTables() {
                        dataTablesOptions("#countryElement", "tableCountryElement", "AjaxCdKantorCabang", "list", callBackDataTables);
                    }
