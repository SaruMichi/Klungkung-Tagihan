<%-- 
    Document   : hub_dgn_pelapor
    Created on : Sep 26, 2016, 7:30:56 AM
    Author     : m20n9
--%>

<%@page import="com.dimata.dslik.form.contentdata.FrmContentDataHubDgnPelapor"%>
...
<%
    boolean privView = userSession.checkPrivG1G2ObjCommand(AppObjInfo.G1_MODUL_MASTER_DATA, AppObjInfo.G2_MAPPING_CONTENT_DATA, AppObjInfo.OBJ_HUBUNGAN_DENGAN_PELAPOR, AppObjInfo.COMMAND_VIEW);
    boolean privAdd = userSession.checkPrivG1G2ObjCommand(AppObjInfo.G1_MODUL_MASTER_DATA, AppObjInfo.G2_MAPPING_CONTENT_DATA, AppObjInfo.OBJ_HUBUNGAN_DENGAN_PELAPOR, AppObjInfo.COMMAND_ADD);
    boolean privUpdate = userSession.checkPrivG1G2ObjCommand(AppObjInfo.G1_MODUL_MASTER_DATA, AppObjInfo.G2_MAPPING_CONTENT_DATA, AppObjInfo.OBJ_HUBUNGAN_DENGAN_PELAPOR, AppObjInfo.COMMAND_UPDATE);
    boolean privDelete = userSession.checkPrivG1G2ObjCommand(AppObjInfo.G1_MODUL_MASTER_DATA, AppObjInfo.G2_MAPPING_CONTENT_DATA, AppObjInfo.OBJ_HUBUNGAN_DENGAN_PELAPOR, AppObjInfo.COMMAND_DELETE);
    boolean privDownload = userSession.checkPrivG1G2ObjCommand(AppObjInfo.G1_MODUL_MASTER_DATA, AppObjInfo.G2_MAPPING_CONTENT_DATA, AppObjInfo.OBJ_HUBUNGAN_DENGAN_PELAPOR, AppObjInfo.COMMAND_DOWNLOAD);
    
%>
<html>
    <head>
        <meta charset="UTF-8">
        <title>SLIK | Mapping Hubungan Dengan Pelapor</title>
        ...
        <div class="wrapper">
            ...
            <div class="content-wrapper">
                ...
                <section class="content-header">
                    <h1>
                        Mapping
                        <small>Hubungan Dengan Pelapor</small>
                    </h1>
                </section>
                <!-- Main content -->
                <%
                                        ...
                                        if(privAdd){
                                            %>
                                                <button class="btn btn-primary btnaddgeneral" data-oid="0" data-for="showform">
                                                    <i class="fa fa-plus"></i> Add Hubungan Dengan Pelapor
                                                </button>	
                                            <%
                                        }
                                    %>		
                ...
                $(document).ready(function(){
                    ...
                    addeditgeneral = function(elementId){
                        $(elementId).click(function(){
                            ...
                            if(oid != 0){
                                if(dataFor == 'showform'){
                                    $(".addeditgeneral-title").html("Edit Hubungan Dengan Pelapor");
                                }

                            }else{
                                if(dataFor == 'showform'){
                                    $(".addeditgeneral-title").html("Add Hubungan Dengan Pelapor");
                                }
                            }
                            ...
                            getDataFunction(onDone, onSuccess, approot, command, dataSend, "AjaxCdHubDgnPelapor", ".addeditgeneral-body", false, "json");
                        });
                    };
                    ...
                    deletegeneral = function(elementId, checkboxelement){
                        ...
                        $(elementId).on("click", checkboxelement, function(){
                            ...
                            if(confirm(confirmText)){
                                ...
                                getDataFunction(onDone, onSuccess, approot, command, dataSend, "AjaxCdHubDgnPelapor", null, true, "json");
                    ...
                    //FORM HANDLER
                    chanelForm = function(){
                        validateOptions("#<%=FrmContentDataHubDgnPelapor.fieldNames[FrmContentDataHubDgnPelapor.FRM_FIELD_HUBUNGAN_DGN_PELAPOR_OID]%>", 'text', 'has-error', 1, null);
                    }
                    ...
                    function runDataTables(){
                        dataTablesOptions("#countryElement", "tableCountryElement", "AjaxCdHubDgnPelapor", "list", callBackDataTables);
                    }
