<%-- 
    Document   : jenis_identitas
    Created on : Sep 27, 2016, 10:35:23 AM
    Author     : m20n9
--%>

<%@page import="com.dimata.dslik.form.contentdata.FrmContentDataJenisIdentitas"%>
...
<%
    boolean privView = userSession.checkPrivG1G2ObjCommand(AppObjInfo.G1_MODUL_MASTER_DATA, AppObjInfo.G2_MAPPING_CONTENT_DATA, AppObjInfo.OBJ_JENIS_IDENTITAS, AppObjInfo.COMMAND_VIEW);
    boolean privAdd = userSession.checkPrivG1G2ObjCommand(AppObjInfo.G1_MODUL_MASTER_DATA, AppObjInfo.G2_MAPPING_CONTENT_DATA, AppObjInfo.OBJ_JENIS_IDENTITAS, AppObjInfo.COMMAND_ADD);
    boolean privUpdate = userSession.checkPrivG1G2ObjCommand(AppObjInfo.G1_MODUL_MASTER_DATA, AppObjInfo.G2_MAPPING_CONTENT_DATA, AppObjInfo.OBJ_JENIS_IDENTITAS, AppObjInfo.COMMAND_UPDATE);
    boolean privDelete = userSession.checkPrivG1G2ObjCommand(AppObjInfo.G1_MODUL_MASTER_DATA, AppObjInfo.G2_MAPPING_CONTENT_DATA, AppObjInfo.OBJ_JENIS_IDENTITAS, AppObjInfo.COMMAND_DELETE);
    boolean privDownload = userSession.checkPrivG1G2ObjCommand(AppObjInfo.G1_MODUL_MASTER_DATA, AppObjInfo.G2_MAPPING_CONTENT_DATA, AppObjInfo.OBJ_JENIS_IDENTITAS, AppObjInfo.COMMAND_DOWNLOAD);
    
%>
<html>
    <head>
        <meta charset="UTF-8">
        <title>SLIK | Mapping Jenis Identitas</title>
                ...
                $(document).ready(function(){
                    ...
                    addeditgeneral = function(elementId){
                        $(elementId).click(function(){
                            ...
                            if(oid != 0){
                                if(dataFor == 'showform'){
                                    $(".addeditgeneral-title").html("Edit Jenis Identitas");
                                }

                            }else{
                                if(dataFor == 'showform'){
                                    $(".addeditgeneral-title").html("Add Jenis Identitas");
                                }
                            }
                            ...
                            getDataFunction(onDone, onSuccess, approot, command, dataSend, "AjaxCdJenisIdentitas", ".addeditgeneral-body", false, "json");
                        });
                    };
                    ...
                    deletegeneral = function(elementId, checkboxelement){
                        ...
                        $(elementId).on("click", checkboxelement, function(){
                            ...
                            if(confirm(confirmText)){
                                ...
                                getDataFunction(onDone, onSuccess, approot, command, dataSend, "AjaxCdJenisIdentitas", null, true, "json");
                    ...
                    //FORM HANDLER
                    chanelForm = function(){
                        validateOptions("#<%=FrmContentDataJenisIdentitas.fieldNames[FrmContentDataJenisIdentitas.FRM_FIELD_JENIS_IDENTITAS_OID]%>", 'text', 'has-error', 1, null);
                    }
                    ...
                    function runDataTables(){
                        dataTablesOptions("#countryElement", "tableCountryElement", "AjaxCdJenisIdentitas", "list", callBackDataTables);
                    }
