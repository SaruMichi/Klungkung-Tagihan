<%-- 
    Document   : configurasi_databases
    Created on : Sep 18, 2016, 6:39:35 PM
    Author     : dimata005
--%>
  ...
  <body class="<%= skin %>">
      ...
      <div class="content-wrapper">
		...
		<div class='box box-primary'>
			...
			<button class="btn btn-primary btnaddgeneral" data-oid="0" data-for="showform">
			    <i class="fa fa-plus"></i> Add Database Connection
			</button>
	...
	$(document).ready(function(){
		...
		$(elementId).click(function(){
		    ...
		    if(oid != 0){
			if(dataFor == 'showform'){
			    $(".addeditgeneral-title").html("Edit Database Connection");
			}

		    }else{
			if(dataFor == 'showform'){
			    $(".addeditgeneral-title").html("Add Database Connection");
			}
		    }
		    ...
		    getDataFunction(onDone, onSuccess, approot, command, dataSend, "AjaxDatabaseConnection", ".addeditgeneral-body", false, "json");
		});
	    };
		...
		$(elementId).click(function(){
			...
			if(confirm(confirmText)){
			    ...
			    getDataFunction(onDone, onSuccess, approot, command, dataSend, "AjaxDatabaseConnection", null, true, "json");
	    ...
	    //FORM HANDLER
	    chanelForm = function(){
		validateOptions("#<%=FrmConnection.fieldNames[FrmConnection.FRM_FIELD_OID]%>", 'text', 'has-error', 1, null);
	    }
		...
		dataTablesOptions("#countryElement", "tableCountryElement", "AjaxDatabaseConnection", "list", callBackDataTables);
	    }
	    
	    modalSetting("#addeditgeneral", "static", false, false);
	    addeditgeneral(".btnaddgeneral");
	    deletegeneral(".btndeleteareatype", ".<%=FrmConnection.fieldNames[FrmConnection.FRM_FIELD_OID]%>");
