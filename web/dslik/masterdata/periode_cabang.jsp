<%-- 
    Document   : periode_cabang
    Created on : Oct 4, 2016, 11:51:24 AM
    Author     : Dewa
--%>

<%@page import="com.dimata.dslik.form.masterdata.FrmPeriodeCabang"%>
...
<%
    boolean privView = userSession.checkPrivG1G2ObjCommand(AppObjInfo.G1_APPROVE_DATA, AppObjInfo.G2_APPROVE_DATA_CABANG, AppObjInfo.OBJ_APPROVE_DATA_CABANG, AppObjInfo.COMMAND_VIEW);
    boolean privApprove = userSession.checkPrivG1G2ObjCommand(AppObjInfo.G1_APPROVE_DATA, AppObjInfo.G2_APPROVE_DATA_CABANG, AppObjInfo.OBJ_APPROVE_DATA_CABANG, AppObjInfo.COMMAND_APPROVE);
%>
<html>
    <head>
        <meta charset="UTF-8">
        <title>SLIK | Approve Data Cabang</title>
    ...
    <body class="<%= skin%>">
        ...
        <input type="hidden" name="privapprove" id="privapprove" value="<%= privApprove %>">
        <div class="wrapper">
                            ...
                            <div class='box box-primary'>
                                ...
                                <div class='box-footer'>
                                    <%--<button class="btn btn-primary btnaddgeneral" data-oid="0" data-for="showform">
                                        <i class="fa fa-plus"></i> Add Periode Cabang
                                    </button>--%>
                ...
                $(document).ready(function () {
                    ...
                    addeditgeneral = function (elementId) {
                        $(elementId).click(function () {
                            ...
                            if (oid != 0) {
                                if (dataFor == 'showform') {
                                    $(".addeditgeneral-title").html("Edit Periode Cabang");
                                }

                            } else {
                                if (dataFor == 'showform') {
                                    $(".addeditgeneral-title").html("Add Periode Cabang");
                                }
                            }
                            ...
                            getDataFunction(onDone, onSuccess, approot, command, dataSend, "AjaxPeriodeCabang", ".addeditgeneral-body", false, "json");
                        });
                    };
                    ...
                    deletegeneral = function (tableId, elementId) {
                        ...
                        $(tableId).on("click", elementId, function () {
                            ...
                            if (confirm(confirmText)) {
                                ...
                                getDataFunction(onDone, onSuccess, approot, command, dataSend, "AjaxPeriodeCabang", null, true, "json");
                    ...
                    updateStatus = function (tableId, elementId) {

                        $(tableId).on("click", elementId, function () {
                            dataFor = $(this).data("for");
                            command = $(this).data("command");
                            oid = $(this).data("oid");
                            var confirmText = "Are you sure want to approve these data?";
                            if (confirm(confirmText)) {
                    ...
                    //FORM HANDLER
              chanelForm = function ()       {
                        validateOptions("#<%=FrmPeriodeCabang.fieldNames[FrmPeriodeCabang.FRM_FIELD_PERIODE_CABANG_ID]%>", 'text', 'has-error', 1, null);
                    }
                    ...
                    function dataTablesOptions(elementIdParent, elementId, servletName, dataFor, callBackDataTables) {
                        ...
                        var privApprove = $("#privapprove").val();
                        ...
                        $("#" + elementId).dataTable({"bDestroy": true,
                            ...
                            "bServerSide": true,
                            "sAjaxSource": "<%= approot%>/" + servletName + "?command=<%= Command.LIST%>&FRM_FIELD_DATA_FILTER=" + datafilter + "&FRM_FIELD_DATA_FOR=" + dataFor + "&privUpdate=" + privUpdate + "&FRM_FLD_APP_ROOT=<%=approot%>&FRM_KODE_CABANG=<%=kd_bank%>&FRM_USER_GROUP=<%=getUserGroup%>&privapprove="+privApprove,
                            aoColumnDefs: [
                                {
                                    bSortable: false,
                                    aTargets: [-1, -2]
                    ...
                    function runDataTables() {
                        dataTablesOptions("#countryElement", "tableCountryElement", "AjaxPeriodeCabang", "list", callBackDataTables);
                    }
                    ...
                    updateStatus("#tableCountryElement", ".btnupdate");
