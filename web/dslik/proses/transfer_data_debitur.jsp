...
<%
    boolean privView = userSession.checkPrivG1G2ObjCommand(AppObjInfo.G1_PROSES_TRANSFER_DATA, AppObjInfo.G2_TRANSFER_DEBITUR_DATA, AppObjInfo.OBJ_TRANSFER_DEBITUR_DATA, AppObjInfo.COMMAND_VIEW);
    boolean privStart = userSession.checkPrivG1G2ObjCommand(AppObjInfo.G1_PROSES_TRANSFER_DATA, AppObjInfo.G2_TRANSFER_DEBITUR_DATA, AppObjInfo.OBJ_TRANSFER_DEBITUR_DATA, AppObjInfo.COMMAND_START);
    boolean privStop = userSession.checkPrivG1G2ObjCommand(AppObjInfo.G1_PROSES_TRANSFER_DATA, AppObjInfo.G2_TRANSFER_DEBITUR_DATA, AppObjInfo.OBJ_TRANSFER_DEBITUR_DATA, AppObjInfo.COMMAND_STOP);
%>
<%
    int iCommand = FRMQueryString.requestCommand(request);
 
    ManagerTransferDataDebitur managerTransferData = new ManagerTransferDataDebitur();
  ...
  <head>
    ...
    <script language="JavaScript">
        ...
        function cmdStart(){
            ...
            document.driver.action="transfer_data_debitur.jsp";
