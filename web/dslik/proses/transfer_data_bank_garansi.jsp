<%-- 
    Document   : transfer_data_bank_garansi
    Created on : Nov 10, 2016, 10:10:19 AM
    Author     : dimata005
--%>
...
<%
    boolean privView = userSession.checkPrivG1G2ObjCommand(AppObjInfo.G1_PROSES_TRANSFER_DATA, AppObjInfo.G2_TRANSFER_BANK_GARANSI_DATA, AppObjInfo.OBJ_TRANSFER_BANK_GARANSI_DATA, AppObjInfo.COMMAND_VIEW);
    boolean privStart = userSession.checkPrivG1G2ObjCommand(AppObjInfo.G1_PROSES_TRANSFER_DATA, AppObjInfo.G2_TRANSFER_BANK_GARANSI_DATA, AppObjInfo.OBJ_TRANSFER_BANK_GARANSI_DATA, AppObjInfo.COMMAND_START);
    boolean privStop = userSession.checkPrivG1G2ObjCommand(AppObjInfo.G1_PROSES_TRANSFER_DATA, AppObjInfo.G2_TRANSFER_BANK_GARANSI_DATA, AppObjInfo.OBJ_TRANSFER_BANK_GARANSI_DATA, AppObjInfo.COMMAND_STOP);
%>
<%
    int iCommand = FRMQueryString.requestCommand(request);
 
    ManagerTransferDataBankGaransi managerTransferData = new ManagerTransferDataBankGaransi();
...
<html>
  <head>
    <meta charset="UTF-8">
    <title>SLIK | Transfer Bank Garansi Data</title>
    ...
    <script language="JavaScript">
        ...
        function cmdStart(){
            ...
            document.driver.action="transfer_data_bank_garansi.jsp";
                      ...
                      <div class='box box-primary'>
                        ...
                        <%if(dateHost.equals(datePeriodeSlik)){%>
                          <div class="box-body">
                              <div class="row">
                                    <div class="col-md-12">
                                        <b>Transfer Data Bank Garansi</b><br>
                                    </div>
                                </div>
