...
<%
    boolean privView = userSession.checkPrivG1G2ObjCommand(AppObjInfo.G1_PROSES_TRANSFER_DATA, AppObjInfo.G2_TRANSFER_AGUNAN_DATA, AppObjInfo.OBJ_TRANSFER_AGUNAN_DATA, AppObjInfo.COMMAND_VIEW);
    boolean privStart = userSession.checkPrivG1G2ObjCommand(AppObjInfo.G1_PROSES_TRANSFER_DATA, AppObjInfo.G2_TRANSFER_AGUNAN_DATA, AppObjInfo.OBJ_TRANSFER_AGUNAN_DATA, AppObjInfo.COMMAND_START);
    boolean privStop = userSession.checkPrivG1G2ObjCommand(AppObjInfo.G1_PROSES_TRANSFER_DATA, AppObjInfo.G2_TRANSFER_AGUNAN_DATA, AppObjInfo.OBJ_TRANSFER_AGUNAN_DATA, AppObjInfo.COMMAND_STOP);
%>
<%
    int iCommand = FRMQueryString.requestCommand(request);
 
    ManagerTransferDataAgunan managerTransferData = new ManagerTransferDataAgunan();
...
<html>
  <head>
    <meta charset="UTF-8">
    <title>SLIK | Transfer Data Agunan</title>
    ...
    <script language="JavaScript">
        ...
        function cmdStart(){
            ...
            document.driver.action="transfer_data_agunan.jsp";
