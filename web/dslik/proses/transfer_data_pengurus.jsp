<%-- 
    Document   : transfer_data_pengurus
    Created on : Nov 10, 2016, 10:12:43 AM
    Author     : dimata005
--%>
...
<%
    boolean privView = userSession.checkPrivG1G2ObjCommand(AppObjInfo.G1_PROSES_TRANSFER_DATA, AppObjInfo.G2_TRANSFER_PENGURUS_PEMILIK_DATA, AppObjInfo.OBJ_TRANSFER_PENGURUS_PEMILIK_DATA, AppObjInfo.COMMAND_VIEW);
    boolean privStart = userSession.checkPrivG1G2ObjCommand(AppObjInfo.G1_PROSES_TRANSFER_DATA, AppObjInfo.G2_TRANSFER_PENGURUS_PEMILIK_DATA, AppObjInfo.OBJ_TRANSFER_PENGURUS_PEMILIK_DATA, AppObjInfo.COMMAND_START);
    boolean privStop = userSession.checkPrivG1G2ObjCommand(AppObjInfo.G1_PROSES_TRANSFER_DATA, AppObjInfo.G2_TRANSFER_PENGURUS_PEMILIK_DATA, AppObjInfo.OBJ_TRANSFER_PENGURUS_PEMILIK_DATA, AppObjInfo.COMMAND_STOP);
%>
<%
    int iCommand = FRMQueryString.requestCommand(request);
 
    ManagerTransferDataPengurusPemilik managerTransferData = new ManagerTransferDataPengurusPemilik();
...
<html>
  <head>
    <meta charset="UTF-8">
    <title>SLIK | Transfer Data Pengurus / Pemilik</title>
    ...
    <script language="JavaScript">
        ...
        function cmdStart(){
            ...
            document.driver.action="transfer_data_pengurus.jsp";
	...
	<%@include file="../../template-component/header-component.jsp" %>
      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          <h1>
            Transfer
            <small>Data Pengurus / Pemilik</small>
          </h1>
        </section>
        <!-- Main content -->
        <%
                      ...
                      <div class='box box-primary'>
                        ...
                        <%if(dateHost.equals(datePeriodeSlik)){%>
                          <div class="box-body">
                              <div class="row">
                                    <div class="col-md-12">
                                        <b>Transfer Data Pengurus Atau Pemilik</b><br>
                                    </div>
                                </div>
