        ...
        <ul class="sidebar-menu">
            <% if(userSession.checkPrivG1G2(AppObjInfo.G1_PROSES_INTEGRASI, AppObjInfo.G2_PHR)){ %>
                <li <%=tree==1?"class=\"treeview active\"":"class=\"treeview\""%> >
                    <a href="#">
                        <i class="fa fa-edit"></i> <span>PHR & ABT </span>
                        ...
                        <% if(userSession.checkPrivG1G2Obj(AppObjInfo.G1_PROSES_INTEGRASI,AppObjInfo.G2_PHR,AppObjInfo.OBJ_UPLOAD_FILE_PHR)){ %>
                            <li <%=menu==1?"class=\"active\"":""%>>
                                <a href="<%=approot%>/dtaxintegration/data/phr.jsp?menu=1&tree=1">
                                    <i class="fa fa-th"></i> <span>Upload File PHR & ABT </span>
                                </a>
                            </li>
                        <%}%>
                        <% if(userSession.checkPrivG1G2Obj(AppObjInfo.G1_PROSES_INTEGRASI,AppObjInfo.G2_PHR,AppObjInfo.OBJ_UPLOAD_OTOMATIS_PHR)){ %>
                            <li <%=menu==24?"class=\"active\"":""%>>
                                <a href="<%=approot%>/dtaxintegration/data/automatic_phr.jsp?menu=24&tree=1">
                                    <i class="fa fa-th"></i> <span>Otomatis Upload PHR & ABT </span>
                                </a>
                            </li>
                        <%}%>
                        <% if(userSession.checkPrivG1G2Obj(AppObjInfo.G1_PROSES_INTEGRASI,AppObjInfo.G2_PHR,AppObjInfo.OBJ_UPLOAD_MANUAL_PHR)){ %>
                            <li <%=menu==2?"class=\"active\"":""%>>
                                <a href="<%=approot%>/dtaxintegration/data/manual_phr.jsp?menu=2&tree=1">
                                    <i class="fa fa-th"></i> <span>Upload Manual PHR & ABT </span>
                                </a>
                            </li>
                        <%}%>
                        ...
                        <% if(userSession.checkPrivG1G2ObjCommand(AppObjInfo.G1_PROSES_INTEGRASI,AppObjInfo.G2_PHR,AppObjInfo.OBJ_DELETE_ALL_INSTANSI_PHR, AppObjInfo.COMMAND_VIEW)){ %>
                            <li <%=menu==31?"class=\"active\"":""%>>
                                <a href="<%=approot%>/dtaxintegration/data/delete_instansi_phr.jsp?menu=31&tree=1">
                                    <i class="fa fa-th"></i> <span>Delete Semua Tagihan PHR & ABT </span>
                                </a>
                            </li>
                        <%}%>
                        <% if(userSession.checkPrivG1G2Obj(AppObjInfo.G1_PROSES_INTEGRASI,AppObjInfo.G2_PHR,AppObjInfo.OBJ_DOWNLOAD_PAYMENT_PHR)){ %>
                            <li <%=menu==3?"class=\"active\"":""%>>
                                <a href="<%=approot%>/dtaxintegration/payment/payment_phr.jsp?menu=3&tree=1">
                                    <i class="fa fa-th"></i> <span>Manual Payment PHR & ABT </span>
                                </a>
                            </li>
                        <%}%>
                    </ul>
            ...
            <% if(userSession.checkPrivG1G2(AppObjInfo.G1_PROSES_INTEGRASI, AppObjInfo.G2_PBB)){ %>
                <li <%=tree==2?"class=\"treeview active\"":"class=\"treeview\""%> >
                    ...
                    <ul class="treeview-menu">
                        <% if(true){
                            //(userSession.checkPrivG1G2Obj(AppObjInfo.G1_PROSES_INTEGRASI,AppObjInfo.G2_PBB,AppObjInfo.OBJ_UPLOAD_FILE_PBB)){ %>
                        ...
                        <% if(userSession.checkPrivG1G2Obj(AppObjInfo.G1_REPORT,AppObjInfo.G2_REPORT_PHR, AppObjInfo.OBJ_REPORT_DETAIL_PHR)){ %>
                            <li <%=menu==13?"class=\"active\"":""%> >
                                <a href="<%=approot%>/dtaxintegration/report/report_phr.jsp?menu=13&tree=5">
                                    <i class="fa fa-th"></i> <span>Report PHR & ABT </span>
                                </a>
                            </li>
                        <%}%>
                        <% if(userSession.checkPrivG1G2Obj(AppObjInfo.G1_REPORT,AppObjInfo.G2_REPORT_PHR, AppObjInfo.OBJ_REPORT_GLOBAL_PHR)){ %>
                            <li <%=menu==190?"class=\"active\"":""%> >
                                <a href="<%=approot%>/dtaxintegration/report/report_phr_harian.jsp?menu=190&tree=5">
                                    <i class="fa fa-th"></i> <span>Report PHR & ABT  Harian</span>
                                </a>
                            </li>
                        <%}%>
                        <% if(userSession.checkPrivG1G2Obj(AppObjInfo.G1_REPORT,AppObjInfo.G2_REPORT_PHR, AppObjInfo.OBJ_REPORT_GLOBAL_PHR)){ %>
                            <li <%=menu==14?"class=\"active\"":""%> >
                                <a href="<%=approot%>/dtaxintegration/report/report_global_phr.jsp?menu=14&tree=5">
                                    <i class="fa fa-th"></i> <span>Report PHR & ABT Global</span>
                                </a>
                            </li>
                        <%}%>
