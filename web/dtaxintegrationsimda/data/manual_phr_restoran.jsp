...
<%!//proses yang akan ditampilkan
    ...
    public String drawListDataPaymentPhrSimda(int iCommand, Vector objectClass, long gradeId) {
        ...
        for (int i = 0; i < objectClass.size(); i++) {
            ...
            TaKartuPajakRestoran entTaKartuPajakRestoran = (TaKartuPajakRestoran) vDataPajak.get(1);
    ...
    <head>
        ...
        <script language="JavaScript">
            ...
            function cmdSearch(){
                ...
                document.driver.action="manual_phr_restoran.jsp";
                document.driver.submit();
            }
