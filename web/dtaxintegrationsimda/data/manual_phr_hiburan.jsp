...
<%@page import="com.dimata.dtaxintegrationsisda.entity.piutang.TaKartuPajakHiburan"%>
<%@page import="com.dimata.dtaxintegrationsisda.entity.piutang.TaKartuPajakRestoran"%>
...
<%!//proses yang akan ditampilkan
    ...
    public String drawListDataPaymentPhrSimda(int iCommand, Vector objectClass, long gradeId) {
        ...
        for (int i = 0; i < objectClass.size(); i++) {
            ...
            TaKartuPajakHiburan entTaKartuPajakRestoran = (TaKartuPajakHiburan) vDataPajak.get(1);
            ...
            rowx.add(""+FRMHandler.userFormatStringDecimal(entTaKartuPajakRestoran.getDasarPengenaan()));//3
            rowx.add(""+FRMHandler.userFormatStringDecimal(entTaKartuPajakRestoran.getTarifPajak()));//3
            rowx.add(""+FRMHandler.userFormatStringDecimal(entTaKartuPajakRestoran.getPajakTerhutang()));//3
            
            
            total=total+entTaKartuPajakRestoran.getPajakTerhutang();
...
<% 
    ...
    if(sNoId!=""){
        ...
        listReportDetail = PstTaKartuPajakPungut.listJoinRestoran(0,0,whereClauseSqlServer, ""); //inquery.InqueryPHR(inqueryProses);
        nameComp = sessSimpatdaSimda.getNoWpSimda(sNoId);
    }
   
    /*data di view_sptpd_simda*/
    Vector listTagihanPhr = new Vector();
    whereClause = "NPWPD='"+sNoId+"' AND  SUBSTR(NPWPD,1,1) = '3' AND TAHUN_PAJAK='"+tahun+"' ";//PstPaymentPhr.fieldNames[PstPaymentPhr.FLD_TANGGAL]+" = TO_DATE ('"+oDate+"','YYYY-MM-DD HH24:MI:SS')";
    ...
    <head>
        ...
        <script language="JavaScript">
            ...
            function cmdSearch(){
                ...
                document.driver.action="manual_phr_hiburan.jsp";
                document.driver.submit();
            }
