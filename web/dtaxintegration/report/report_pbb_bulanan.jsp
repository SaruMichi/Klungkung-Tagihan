...
<%!//proses yang akan ditampilkan
    ...
    public String drawListDataPaymentPBBDispendaHarian(int iCommand, Vector objectClass, long gradeId) {
        ...
        for (int i = 0; i < objectClass.size(); i++) {
            ...
            rowx.add(""+count);//1
            rowx.add(""+Formater.formatDate(paymentPbb.getTglPembayaranSppt(), "MMMM YYYY").toUpperCase());//2
            rowx.add(""+Formater.formatNumber(pokok,"#,###"));//3
            rowx.add(""+Formater.formatNumber(paymentPbb.getDendaSppt(),"#,###"));//4
            rowx.add(""+Formater.formatNumber(paymentPbb.getJmlSpptYgDibayar(),"#,###"));//6
            total=total+paymentPbb.getJmlSpptYgDibayar();
...
<% 
   ...
   /* EchoLaporanPaymentDetail echoLaporan = new EchoLaporanPaymentDetail();
    ...
    listPaymentPBB = PstPaymentPbb.listPerBulan(0, 0, whereClause, 
