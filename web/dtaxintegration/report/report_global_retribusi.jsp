<%-- 
    Document   : report_global_retribusi
    Created on : Jul 20, 2015, 9:59:34 AM
    Author     : dimata005
--%>
...
<%!
    ...
    public String drawListDataPaymentDispenda(int iCommand, Vector objectClass, long gradeId) {
        ...
        ctrlist.addHeader("TOTAL SETORAN", "200px");//10
        ...
        for (int i = 0; i < objectClass.size(); i++) {
            ...
            rowx.add(""+count);//1
            //rowx.add(""+FRMHandler.userFormatStringDecimal(paymentRetribusi.getPokok()));//2
            //rowx.add(""+FRMHandler.userFormatStringDecimal(paymentRetribusi.getDenda()));//4
            ...
            pokok=pokok+paymentRetribusi.getPokok();
            denda=denda+paymentRetribusi.getDenda();
            lstData.add(rowx);
        }
    ...
    <head>
        ...
        <script language="JavaScript">
            ...
            function cmdPrint(){
                ...
                document.driver.action="report_global_retribusi.jsp";
            ...
            function cmdPrintExcel(){
                var myWindow = window.open("report_global_retribusi_excel.jsp?tanggalStart=<%=oDate%>&tanggalEnd=<%=oEnd%>&exchangeRate=<%=exchangeRate%>&pemotongan=<%=pemotongan%>", "MsgWindow", "toolbar=no, scrollbars=yes, resizable=yes, top=500, left=500, width=1500, height=800");
                if (window.focus) 
                 {
                   myWindow.focus();
                 }
            ...
            function cmdPrintPdf(){
                var myWindow = window.open("<%=printrootx%>.print.report_retribusi_global_pdf?tanggalStart=<%=oDate%>&tanggalEnd=<%=oEnd%>&exchangeRate=<%=exchangeRate%>&pemotongan=<%=pemotongan%>","",'scrollbars=yes,status=yes,width=750,height=600,resizable=yes');
                if (window.focus) 
                 {
                   myWindow.focus();
                 }
            ...
            <aside class="right-side">                
                ...
                <section class="content-header">
                    <h1>
                       Pajak dan Retribusi Daerah Terintegrasi Pembayaran Online
                        <small>Report Global Retribusi</small>
                    </h1>
                    <!--<ol class="breadcrumb">
                ...
                <section class="content">
                    <form name="driver"  method ="post" action="" role="form">
                        ...
                        <input type="hidden" name="menu" value="27">
                            ...
                            <div class="col-xs-12">
                               <div class="box">
                                   ...
                                   <div class="box-header">
                                       ...
                                       <% if(userSession.checkPrivG1G2Obj(AppObjInfo.G1_PROSES_INTEGRASI,AppObjInfo.G2_REPORT_RETRIBUSI,AppObjInfo.OBJ_REPORT_GLOBAL_RETRIBUSI)){ %>
                                           <div class="col-xs-2"><label>&nbsp;</label>  
