<%-- 
    Document   : delete_instansi_pbb
    Created on : Aug 2, 2015, 11:01:08 AM
    Author     : xml
--%>
...
<% //proses yang tidak akan ditampilkan hanya diserver side
    ...
    DTaxManagerAutomaticPhr dTaxManagerAutomaticPhr = new DTaxManagerAutomaticPhr();
    ...
    switch (iCommand) {
        case Command.START:
            ...
            if(code.equals("00")){
                ...
                //hapus data di log
                String whereDelete = ""+PstLogHistoryTransaksi.fieldNames[PstLogHistoryTransaksi.FLD_INSTANSI]+"='PBB_GIANYAR'";
                        ...
                        <div class="row">
                            <div class="col-xs-12">
                               <div class="box">
                                   ...
                                   <div class="box-header">
                                       <div class="col-xs-12"><label>DELETE TAGIHAN INSTANSI PBB</label>
