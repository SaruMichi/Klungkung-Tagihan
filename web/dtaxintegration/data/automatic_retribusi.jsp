<%-- 
    Document   : automatic_retribusi
    Created on : Jun 11, 2015, 9:12:27 AM
    Author     : xml
--%>

<%@page import="com.dimata.dtaxintegration.session.DTaxManagerRetribusi"%>
<%-- 
...
<% //proses yang tidak akan ditampilkan hanya diserver side
    ...
    DTaxManagerRetribusi dTaxManagerRetribusi = new DTaxManagerRetribusi();
    ...
    switch (iCommand) {
        ...
        case Command.START:
           ...
           dTaxManagerRetribusi.startMonitor();
        ...
        case Command.STOP:
            ...
            dTaxManagerRetribusi.stopMonitor();

            break;

    }
    boolean running = dTaxManagerRetribusi.getStatus();
%>
<html>
    <head>
        <meta charset="UTF-8">
                        ...
                        <div class="row">
                            <div class="col-xs-12">
                               <div class="box">
                                   ...
                                   <div class="box-header">
                                       <div class="col-xs-12"><label>Monitoring Retribusi Service</label>
                                           <table width="85%" border="0" cellspacing="1" cellpadding="1" align="center">

                                                                <tr> 

                                                                    <td colspan="3" class="title"><b>Monitoring Retribusi Service</b></td>
                                                                ...
                                                                <% if(userSession.checkPrivG1G2ObjCommand(AppObjInfo.G1_PROSES_INTEGRASI,AppObjInfo.G2_RETRIBUSI, AppObjInfo.OBJ_UPLOAD_OTOMATIS_RETRIBUSI, AppObjInfo.COMMAND_UPLOAD)){ %>
                                                                <tr> 
