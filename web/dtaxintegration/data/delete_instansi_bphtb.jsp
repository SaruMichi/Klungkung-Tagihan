<%-- 
    Document   : delete_instansi_bphtb
    Created on : Aug 2, 2015, 11:24:51 AM
    Author     : xml
--%>
    ...
    switch (iCommand) {
        case Command.START:
            ...
            if(code.equals("00")){
                ...
                //hapus data di log
                String whereDelete = ""+PstLogHistoryTransaksi.fieldNames[PstLogHistoryTransaksi.FLD_INSTANSI]+"='BPHTB_GIANYAR'";
                                       ...
                                       <div class="col-xs-12">
                                           <table width="85%" border="0" cellspacing="1" cellpadding="1" align="center">
                                                                ...
                                                                <tr> 
                                                                    ...
                                                                    <td colspan="3" class="title"><b>DELETE BPHTB</b></td>
