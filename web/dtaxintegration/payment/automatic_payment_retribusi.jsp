<%-- 
    Document   : automatic_payment_retribusi
    Created on : Sep 15, 2015, 11:41:35 PM
    Author     : Administrator
--%>
<%@page import="com.dimata.dtaxintegration.session.DTaxIntegrationManagerPaymentRetribusi"%>
...
<% //proses yang tidak akan ditampilkan hanya diserver side
    ...
    DTaxIntegrationManagerPaymentRetribusi dTaxIntegrationManagerPaymentRetribusi = new DTaxIntegrationManagerPaymentRetribusi();
    ...
    switch (iCommand) {
        ...
        case Command.START:
            ...
            dTaxIntegrationManagerPaymentRetribusi.startMonitor();
        ...
        case Command.STOP:
            ...
            dTaxIntegrationManagerPaymentRetribusi.stopMonitor();

            break;

    }
    boolean running = dTaxIntegrationManagerPaymentRetribusi.getStatus();
%>
<html>
    <head>
        <meta charset="UTF-8">
            ...
            <aside class="right-side">                
                ...
                <section class="content">
                    <form name="fr_syslog"  method ="post" action="" role="form">
                        ...
                        <input type="hidden" name="start" value="<%=start%>">
                        <input type="hidden" name="menu" value="90">
                        ...
                        <div class="row">
                            <div class="col-xs-12">
                               <div class="box">
                                   ...
                                   <div class="box-header">
                                       <div class="col-xs-12"><label> Download Otomatis Pembayaran Retribusi</label>
