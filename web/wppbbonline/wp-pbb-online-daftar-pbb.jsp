    ...
    <script type="text/javascript">
        $(document).ready(function() {  
            ...
            var tableData1 = $('#tabledata1').dataTable({
                ...
                "bProcessing" : true,
                "bServerSide" : true,
                "sAjaxSource" : "<%= request.getContextPath() %>/AjaxPbb?Command=<%= Command.LIST%>&nop=<%= wajibPajak.getNop()%>",
                          ...
                          <div class="widget ">
                              ...
                              <div class="widget-content">
                                    <div class="table-responsive" style="overflow-x: auto;">                                   
                                        <table style="width: 100%" class=" table table-striped table-bordered table-hover display" id="tabledata2">
                                            <thead>
                                                <tr>
                                                    <th>NOP</th>
                                                    <th>Kode Propinsi</th>
