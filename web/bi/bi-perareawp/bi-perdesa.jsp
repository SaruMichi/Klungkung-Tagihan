...
<div class="row">
	...
	<div class="box bix-primary">
		...
		<div class="col-md-2" style="margin-top:12px;">
		    <%= ControlCombo.drawBootsratap(FrmDataPajak.fieldNames[FrmDataPajak.FRM_FIELD_TAHUN]+"_DESA", null, ""+thisYear, tahun, tahun, "", "form-control WP_FILTER") %> 
		</div>
	...
	<div class="box bix-primary">
	    <div class="box-header">
		<div class="box-title">
		    Top 20 Desa Penghasil Pajak
		</div>
	    </div>
	    <div class="box-body">
		<div id="perdesa" style="height: 300px;"></div>
	    </div>
	</div>
    </div>
    <div class='col-md-12'>
	<div class="box bix-primary">
	    <div class="box-header">
		<div class="box-title">
		    Tabel Top 20 Desa Penghasil Pajak
		</div>
	    </div>
	    <div class="box-body">
		<div id="tabelperdesa"></div>
	    </div>
	</div>
    </div>
</div>
