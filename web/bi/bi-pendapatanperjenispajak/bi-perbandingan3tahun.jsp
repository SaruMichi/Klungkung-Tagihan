...
<div class="row">
	...
	<div class="box bix-primary">
		...
		<div class="box-title">Pendapatan Pajak Tahun Sampai</div>
		<div class="col-md-2" style="margin-top:12px;">
		    <%= ControlCombo.drawBootsratap(FrmDataPajak.fieldNames[FrmDataPajak.FRM_FIELD_TAHUN]+"_3_TAHUN", null, ""+thisYear, tahun, tahun, "", "form-control") %> 
		</div>
	...
	<div class="box box-primary">
	    <div class="box-header">
		<h3 class="box-title">Perkembangan 3 Tahun</h3>
	    </div>
	    <div class="box-body chart-responsive">
		<div id="perbandingan3tahun" style="height: 300px;"></div>
	    </div>
	</div>
    </div>
    <div class="col-md-6">
	<div class="box box-primary">
	    <div class="box-header">
		<h3 class="box-title">Tabel Perkembangan 3 Tahun</h3>
	    </div>
	    <div class="box-body chart-responsive">
		<div id="tabelperbandingan3tahun" style="height: 300px;overflow-x: auto"></div>
	    </div>
	</div>
    </div>
	...
	if(listPajakType.size() != 0){
		...
		<div class="col-md-6">
			...
			<div class="box-body chart-responsive">
			    <div id="perbandinganperjenispajak<%= pajakType.getOID() %>" style="height: 300px;overflow-x: auto"></div>
			</div>
		    </div>
		</div>
		<%
	...
	<div class="box box-primary">
	    <div class="box-header">
		<h3 class="box-title">Perbandingan 3 Tahun</h3>
	    </div>
	    <div class="box-body chart-responsive">
		<div id="perbandinganperbulan3tahun" style="height: 300px;overflow-x: auto"></div>
	    </div>
	</div>
    </div>
</div>
