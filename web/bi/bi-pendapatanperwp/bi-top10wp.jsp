...
<div class="row">
	...
	<div class="box bix-primary">
		...
		<div class="col-md-2" style="margin-top:12px;">
		    <%= ControlCombo.drawBootsratap(FrmDataPajak.fieldNames[FrmDataPajak.FRM_FIELD_TAHUN]+"_WP", null, ""+thisYear, tahun, tahun, "", "form-control WP_FILTER") %> 
		</div>
		<div class='box-title'>Jenis Pajak</div>
		<div class="col-md-2" style='margin-top:12px;'>
		    <%= ControlCombo.drawBootsratap(FrmDataPajak.fieldNames[FrmDataPajak.FRM_FIELD_PAJAKDETAILID], null, "", pajakType_key, pajakType_val, "", "form-control WP_FILTER") %> 
		</div>
	...
	<div class="box bix-primary">
	    <div class="box-header">
		<div class="box-title">
		    Top 10 - <span class="wp"></span>
		</div>
	    </div>
	    <div class="box-body">
		<div id="top10wpcolumn" style="height: 300px;"></div>
	    </div>
	</div>
    </div>
    <div class='col-md-6'>
	<div class="box bix-primary">
	    ...
	    <div class="box-body">
		<div id="top10wpline" style="height: 300px;"></div>
	    </div>
	</div>
    </div>
    <div class='col-md-12'>
	<div class="box bix-primary">
	    <div class="box-header">
		<div class="box-title">
		    Tabel Top 10 - <span class="wp"></span>
		</div>
	    </div>
	    <div class="box-body">
		<div id="tabeltop10wp"></div>
	    </div>
	</div>
    </div>
</div>
