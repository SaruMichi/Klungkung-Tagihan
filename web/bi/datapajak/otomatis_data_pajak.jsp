<%-- 
    Document   : otomatis_data_pajak
    Created on : Jan 19, 2016, 6:25:21 PM
    Author     : Administrator
--%>
<%-- 
    Document   : automatic_phr
    Created on : Jul 17, 2015, 11:02:58 AM
    Author     : dimata005
--%>

<%@page import="com.dimata.dtaxintegration.session.DTaxManagerAutomaticDataPajakBI"%>
<%-- 
...
<% //proses yang tidak akan ditampilkan hanya diserver side
    ...
    boolean running = dTaxManagerAutomaticDataPajakBI.getStatus();
                                       ...
                                       <div class="col-xs-12"><label>Monitoring PHR Service</label>
                                           <table width="85%" border="0" cellspacing="1" cellpadding="1" align="center">
                                                                ...
                                                                <tr> 
                                                                    ...
                                                                    <td colspan="3" class="title"><b>Monitoring PHR Service</b></td>
                                                                ...
                                                                <tr> 
                                                                    <td colspan="3"> 
                                                                        <%=dTaxManagerAutomaticDataPajakBI.getNote()%>
                                                                    </td>
                                                                </tr>
                                                                <tr> 
                                                                    <td colspan="3"> 
