<%-- 
    Document   : report_bus_revenue_summary_excel
    Created on : May 1, 2015, 2:57:42 PM
    Author     : dimata005
--%>
...
<html>
    <head>
        <meta charset="UTF-8">
        <title>Report Bus Revenue</title>
        ...
        <table width="100%" cellspacing="0" cellpadding="3">
            <tr align="left" valign="top">
                  <td height="14" valign="middle" colspan="3" class="command">
                   <b><strong>
                        REPORT BUS REVENUE SUMMARY <%=startDate%> S/D <%=endDate%>
                    </strong></b>
                    </td>
                </tr>
        </table>
