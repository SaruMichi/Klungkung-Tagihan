<%-- 
    Document   : ReportDetailSummary
    Created on : May 1, 2015, 10:04:24 AM
    Author     : dimata005
--%>
...
<html>
    <head>
        ...
        <script language="JavaScript">
            ...
            function cmdPrint(){
                var myWindow = window.open("report_detail_excel.jsp?tanggalStart=<%=startDate%>&tanggalEnd=<%=endDate%>&exchangeRate=<%=exchangeRate%>&pemotongan=<%=pemotongan%>", "MsgWindow", "toolbar=no, scrollbars=yes, resizable=yes, top=500, left=500, width=1500, height=800");
                if (window.focus) 
                 {
                   myWindow.focus();
                 }
            ...
            function cmdSearch(){
                ...
                document.driver.action="report_detail.jsp";
