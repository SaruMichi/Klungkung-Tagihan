<%-- 
    Document   : logout_bi.
    Created on : Nov 26, 2015, 11:58:04 PM
    Author     : dimata005
--%>

<%-- 
    Document   : logout
    Created on : Mar 11, 2015, 4:43:20 PM
    Author     : dimata005
--%>
<%@ page language="java" %>
            ...
            <tr>       
                <td align="center">  
                    <table width="40%" cellspacing="2" cellpadding="2" align="center">
                            ...
                            <td width="68%" height="20"> 
                                <div align="center">
                                    ...
                                    <p>
                                        ...
                                        <span class="smalllogintitle"><font color="#0000CC" size="2">- APLIKASI INFORMASI BISNIS INTELIJEN -</font></span>
                                    </p>
                                    <p>&nbsp;</p>
                                </div>
                            </td>
                        ...
                        <tr> 
                            <td width="68%" height="40" align="center"> <a href="javascript:closeWindow()">EXIT</a> | <a href="login_bi.jsp">LOGIN </a></td>
                        </tr>
                    </table>
                </td> 
            </tr>
