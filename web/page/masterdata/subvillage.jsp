...
<html>
  <head>
    <meta charset="UTF-8">
    <title>Di-SMARTCITY | SUB VILLAGE</title>
  ...
  <body class="<%= skin %>">
	...
	<%@include file="../../template-component/sidebar-component.jsp" %>
      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          <h1>
            Master Data
            <small>Sub Village</small>
          </h1>
          <ol class="breadcrumb">
            <li><a href="#"><i class="fa fa-dashboard"></i> Master Data</a></li>
            <li class="active">Sub Village</li>
          </ol>
        </section>
		...
		<div class='box box-primary'>
			...
			<button class="btn btn-primary btnaddgeneral" data-oid="0" data-for="showsubvillageform">
			    <i class="fa fa-plus"></i> Add Sub Village
			</button>
			<button class="btn btn-danger btndeleteareatype" data-for="subvillage">
	...
	$(document).ready(function(){
	    ...
	    activeMenu("#masterdata", "#subvillage");
		...
		$(elementId).click(function(){
		    ...
		    //SET TITLE MODAL
		    if(oid != 0){
			if(dataFor == 'showsubvillageform'){
			    $(".addeditgeneral-title").html("Edit Sub Village");
			}

		    }else{
			if(dataFor == 'showsubvillageform'){
			    $(".addeditgeneral-title").html("Add Sub Village");
			}
		    }
		    ...
		    getDataFunction(onDone, onSuccess, approot, command, dataSend, "AjaxDusun", ".addeditgeneral-body", false, "json");
		});
	    };
		...
		$(elementId).click(function(){
			...
			if(confirm(confirmText)){
			    ...
			    if(dataFor == "subvillage"){
				onDone = function(data){
				    runDataTables();
				};
			    }
			    getDataFunction(onDone, onSuccess, approot, command, dataSend, "AjaxDusun", null, true, "json");
	    ...
	    //FORM HANDLER
	    chanelForm = function(){
		validateOptions("#<%= FrmDusun.fieldNames[FrmDusun.FRM_FIELD_ID_DESA] %>", 'text', 'has-error', 1, null);
                validateOptions("#<%= FrmDusun.fieldNames[FrmDusun.FRM_FIELD_NAMA_DUSUN] %>", 'text', 'has-error', 1, null);
                validateOptions("#<%= FrmDusun.fieldNames[FrmDusun.FRM_FIELD_KD_DUSUN] %>", 'text', 'has-error', 1, null);
	    }
		...
		dataTablesOptions("#subVillageElement", "tableSubVillageElement", "AjaxDusun", "listsubvillage", callBackDataTables);
	    }
	    ...
	    deletegeneral(".btndeleteareatype", ".<%= FrmDusun.fieldNames[FrmDusun.FRM_FIELD_ID_DUSUN]%>");
		...
		if(generaldatafor == "showsubvillageform"){
		    chanelForm();
		    onDone = function(data){
			runDataTables();
		    };
