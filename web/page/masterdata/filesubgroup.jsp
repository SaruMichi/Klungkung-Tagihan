...
<html>
  <head>
    <meta charset="UTF-8">
    <title>DIAMAS | FILE SUB GROUP</title>
  ...
  <body class="<%= skin %>">
	...
	<%@include file="../../template-component/sidebar-component.jsp" %>
      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          <h1>
            Master Data
            <small>File Sub Group</small>
          </h1>
          <ol class="breadcrumb">
            <li><a href="#"><i class="fa fa-dashboard"></i> Master Data</a></li>
            <li class="active">File Sub Group</li>
          </ol>
        </section>
		...
		<div class='box box-primary'>
			...
			<button class="btn btn-primary btnaddgeneral" data-oid="0" data-for="showfilesubgroupform">
			    <i class="fa fa-plus"></i> Add File Main Group
			</button>
                        <button class="btn btn-danger btndeleteareausage" data-for="filesubgroup">
	...
	$(document).ready(function(){
	    ...
	    activeMenu("#masterdata", "#filesubgroup");
		...
		$(elementId).click(function(){
		    ...
		    //SET TITLE MODAL
		    if(oid != 0){
			if(dataFor == 'showfilesubgroupform'){
		    ...
		    getDataFunction(onDone, onSuccess, approot, command, dataSend, "AjaxFileSubGroup", ".addeditgeneral-body", false, "json");
		});
	    };
		...
		$(elementId).click(function(){
			...
			if(confirm(confirmText)){
			    ...
			    if(dataFor == "filesubgroup"){
				onDone = function(data){
				    dataTablesOptions("#fileSubGroup", "tableAreaTypeElement", "AjaxFileSubGroup", "listfilesubgroup", callBackDataTables);
				};
			    }
			    getDataFunction(onDone, onSuccess, approot, command, dataSend, "AjaxFileSubGroup", null, true, "json");
		...
		validateOptions("#<%= FrmDataUploadMain.fieldNames[FrmDataUploadMain.FRM_FIELD_DATA_GROUP_ID] %>", 'text', 'has-error', 1, null);
		validateOptions("#<%= FrmDataUploadMain.fieldNames[FrmDataUploadMain.FRM_FIELD_DATA_MAIN_ID] %>", 'text', 'has-error', 1, null);
                validateOptions("#<%= FrmDataUploadMain.fieldNames[FrmDataUploadMain.FRM_FIELD_DATA_MAIN_DESC] %>", 'text', 'has-error', 1, null);
	    ...
	    deletegeneral(".btndeleteareausage", ".<%= FrmDataUploadMain.fieldNames[FrmDataUploadMain.FRM_FIELD_DATA_MAIN_ID]%>");
		...
		if(generaldatafor == "showfilesubgroupform"){
		    areaUsageForm();
		    onDone = function(data){
                        //alert("test");
			runDataTables();
