...
<html>
  <head>
    <meta charset="UTF-8">
    <title>Di-SMARTCITY | CHANEL TYPE</title>
  ...
  <body class="<%= skin %>">
	...
	<%@include file="../../template-component/sidebar-component.jsp" %>
      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          <h1>
            Master Data
            <small>Chanel Type</small>
          </h1>
          <ol class="breadcrumb">
            <li><a href="#"><i class="fa fa-dashboard"></i> Master Data</a></li>
            <li class="active">Chanel Type</li>
          </ol>
        </section>
		...
		<div class='box box-primary'>
			...
			<button class="btn btn-primary btnaddgeneral" data-oid="0" data-for="showchaneltypeform">
			    <i class="fa fa-plus"></i> Add Chanel Type
			</button>
			<button class="btn btn-danger btndeleteareatype" data-for="chaneltype">
	...
	$(document).ready(function(){
	    ...
	    activeMenu("#masterdata", "#chaneltype");
		...
		$(elementId).click(function(){
		    ...
		    //SET TITLE MODAL
		    if(oid != 0){
			if(dataFor == 'showchaneltypeform'){
			    $(".addeditgeneral-title").html("Edit Chanel Type");
			}

		    }else{
			if(dataFor == 'showchaneltypeform'){
			    $(".addeditgeneral-title").html("Add Chanel Type");
			}
		    }
		    ...
		    getDataFunction(onDone, onSuccess, approot, command, dataSend, "AjaxChanelType", ".addeditgeneral-body", false, "json");
		});
	    };
		...
		$(elementId).click(function(){
			...
			if(confirm(confirmText)){
			    ...
			    getDataFunction(onDone, onSuccess, approot, command, dataSend, "AjaxChanelType", null, true, "json");
	    ...
	    //FORM HANDLER
	    chanelTypeForm = function(){
		validateOptions("#<%= FrmChanelType.fieldNames[FrmChanelType.FRM_FIELD_NAME] %>", 'text', 'has-error', 1, null);
		validateOptions("#<%= FrmChanelType.fieldNames[FrmChanelType.FRM_FIELD_POSITION_MENU] %>", 'text', 'has-error', 1, null);
	    }
		...
		dataTablesOptions("#chanelTypeElement", "tablechanelTypeElement", "AjaxChanelType", "listchaneltype", callBackDataTables);
	    }
	    
	    modalSetting("#addeditgeneral", "static", false, false);
	    addeditgeneral(".btnaddgeneral");
	    deletegeneral(".btndeleteareatype", ".<%= FrmChanelType.fieldNames[FrmChanelType.FRM_FIELD_CHANEL_TYPE_ID]%>");
		...
		if(generaldatafor == "showchaneltypeform"){
		    chanelTypeForm();
		    onDone = function(data){
			runDataTables();
		    };
