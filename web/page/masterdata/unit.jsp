<%@page import="com.dimata.balismartisland.form.FrmUnitData"%>
  ...
  <body class="<%= skin %>">
		...
		<div class='box box-primary'>
			...
			<div id="unitElement">
				...
				<thead>
					...
					<th style="width:50%">Unit Code</th>					
			...
			<button class="btn btn-primary btnaddgeneral" data-oid="0" data-for="showunitform">
			    <i class="fa fa-plus"></i> Add Unit
			</button>
                        <button class="btn btn-danger btndeleteunit" data-for="unit">
	...
	$(document).ready(function(){
		...
		$(elementId).click(function(){
		    ...
		    //SET TITLE MODAL
		    if(oid != 0){
			if(dataFor == 'showunitform'){
			    $(".addeditgeneral-title").html("Edit Unit");
			}

		    }else{
			if(dataFor == 'showunitform'){
			    $(".addeditgeneral-title").html("Add Unit");
			}
		    }
		    ...
		    getDataFunction(onDone, onSuccess, approot, command, dataSend, "AjaxUnit", ".addeditgeneral-body", false, "json");
		});
	    };
		...
		$(elementId).click(function(){
			...
			if(confirm(confirmText)){
			    ...
			    if(dataFor == "unit"){
				onDone = function(data){
				    dataTablesOptions("#unitElement", "tableAreaTypeElement", "AjaxUnit", "listunit", callBackDataTables);
				};
			    }
			    getDataFunction(onDone, onSuccess, approot, command, dataSend, "AjaxUnit", null, true, "json");
	    ...
	    //FORM HANDLER
	    unitForm = function(){
		validateOptions("#<%= FrmUnitData.fieldNames[FrmUnitData.FRM_FIELD_UNIT_NAME] %>", 'text', 'has-error', 1, null);
		validateOptions("#<%= FrmUnitData.fieldNames[FrmUnitData.FRM_FIELD_UNIT_KODE] %>", 'text', 'has-error', 1, null);
	    }
	    ...
	    deletegeneral(".btndeleteunit", ".<%= FrmUnitData.fieldNames[FrmUnitData.FRM_FIELD_UNIT_DATA_ID]%>");
		...
		if(generaldatafor == "showunitform"){
		    unitForm();
		    onDone = function(data){
                        //alert("test");
			runDataTables();
