...
<html>
  ...
  <body class="<%= skin %>">
	...
	<%@include file="../../template-component/sidebar-component.jsp" %>
      ...
      <div class="content-wrapper">
		...
		<div class='box box-primary'>
			...
			<button class="btn btn-primary btnaddgeneral" data-oid="0" data-for="showareatypeform">
			    <i class="fa fa-plus"></i> Add Area Type
			</button>
			<button class="btn btn-danger btndeleteareatype" data-for="areatype">
	...
	$(document).ready(function(){
	    ...
	    activeMenu("#masterdata", "#areatype");
		...
		$(elementId).click(function(){
		    ...
		    //SET TITLE MODAL
		    if(oid != 0){
			if(dataFor == 'showareatypeform'){
			    $(".addeditgeneral-title").html("Edit Area Type");
			}

		    }else{
			if(dataFor == 'showareatypeform'){
			    $(".addeditgeneral-title").html("Add Area Type");
			}
		    }
		    ...
		    getDataFunction(onDone, onSuccess, approot, command, dataSend, "AjaxAreaType", ".addeditgeneral-body", false, "json");
		});
	    };
		...
		$(elementId).click(function(){
			...
			if(confirm(confirmText)){
			    ...
			    getDataFunction(onDone, onSuccess, approot, command, dataSend, "AjaxAreaType", null, true, "json");
	    ...
	    //FORM HANDLER
	    areaTypeForm = function(){
		validateOptions("#<%= FrmAreaType.fieldNames[FrmAreaType.FRM_FIELD_AREA_TYPE_DETAIL] %>", 'text', 'has-error', 1, null);
		validateOptions("#<%= FrmAreaType.fieldNames[FrmAreaType.FRM_FIELD_AREA_TYPE_NAME] %>", 'text', 'has-error', 1, null);
	    }
		...
		dataTablesOptions("#areaTypeElement", "tableAreaTypeElement", "AjaxAreaType", "listareatype", callBackDataTables);
	    }
	    
	    modalSetting("#addeditgeneral", "static", false, false);
	    addeditgeneral(".btnaddgeneral");
	    deletegeneral(".btndeleteareatype", ".<%= FrmAreaType.fieldNames[FrmAreaType.FRM_FIELD_AREA_TYPE_ID]%>");
		...
		if(generaldatafor == "showareatypeform"){
		    areaTypeForm();
		    onDone = function(data){
			runDataTables();
		    };
